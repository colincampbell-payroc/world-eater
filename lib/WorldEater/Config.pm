    ...
    return {
        ...
        applications => [
            ...
            {   name               => 'authproxy',
                ...
                ignore_list        => [qw{ monitor Monitors log log-verbose }]
            },
            ...
            {   name               => 'lantrans',
                ...
                ignore_list        => [qw{ lantrans/archive lantrans/certs lantrans/log lt3shared lantrans-support preauth-purge unsettled-batch-report }]
            },
            ...
            {   name               => 'padapi',
                ...
                repo_sub_directory => '/src/padapi',
                server_name        => 'pad',
                path_on_server     => '/home/padapi',
                ignore_list        => [qw{ keys log }]
            },
            {   name               => 'convfee',
