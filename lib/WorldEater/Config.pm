    ...
    return {
        ...
        applications => [
            ...
            {   name               => 'acquiring_mastercard',
                ...
                repo_sub_directory => '/mastercard',
                server_name        => 'batchmaster',
                path_on_server     => '/home/mcrd/parseIPMandTsys',
                ignore_list        => [
                    qw{ mCard/perl/archive mCard/perl/in_files mCard/perl/in_files_prod mCard/perl/in_tsys mCard/perl/logs mCard/perl/logs-old
                        mCard/perl/rej mCard/perl/TEST mCard/perl/test_files Tsys/archives Tsys/logs Tsys/send_to_tsys Tsys/sent_to_tsys_BKP
                        Tsys/crontab.txt PROD keys }
                ]
            },
            {   name               => 'mipproxy',
                repo_url           => 'git@github.com:payroc/Caledon-AuthProxy-Monitor.git',
